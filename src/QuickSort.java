...
public class QuickSort {
   ...
   */
  public static < Double extends Comparable < Double >> void sort(double[] table) {
   ...
   */
  private static < Double  extends Comparable < Double >> void quickSort(double[] table,
                                               int first,
                                               int last) {
  ...
  private static < Double
      extends Comparable < Double >> int partition(double[] table,
                                              int first,
                                              int last) {
    // Select the first item as the pivot value.
    double pivot = table[first];
    int up = first;
    int down = last;
    do {
      /* Invariant:
  ...
  private static < Integer
      extends Comparable < Integer >> void swap(double[] table,
                                                int i, int j) {
    double temp = table[i];
    table[i] = table[j];
    table[j] = temp;
